...
export default function Contato() {
  return (
    ...
    <main className="flex-1 flex flex-col items-center justify-center py-16 px-6 w-full relative z-20 bg-transparent">
      ...
      <div className="w-full max-w-6xl mx-auto text-center mb-44 md:mb-64">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex flex-col items-center justify-center h-full space-y-6 md:space-y-10">
            ...
            <a
                ...
                className="w-full max-w-sm flex items-center justify-center gap-4 py-6 px-10 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 rounded-full shadow-[0_0_30px_rgba(220,38,38,0.6)] hover:shadow-[0_0_50px_rgba(220,38,38,0.8)] transition-all transform hover:scale-110"
              >
                ...
                <span className="text-white font-black text-2xl tracking-tighter drop-shadow-md">@aperformancect</span>
            </a>
            ...
            <a
              ...
              >
                ...
                <span className="text-white font-black text-2xl tracking-tighter drop-shadow-md">WhatsApp</span>
            </a>
