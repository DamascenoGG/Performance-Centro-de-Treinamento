...
export default function Footer() {
  ...
  return (
    <footer 
      ...
      className="bg-black/80 backdrop-blur-lg border-t border-red-900/40 mt-auto relative z-20 py-6 px-6"
    >
      <div style={{ width: '100%', maxWidth: '1200px', margin: '0 auto', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        
        {/* 1. Logo e Nome */}
        <Link href="/" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textDecoration: 'none' }} className="group mb-4">
          <div className="w-12 h-12 relative overflow-hidden rounded-full border-2 border-red-600 shadow-[0_0_15px_rgba(220,38,38,0.3)] mb-2">
            <Image src="/logo.jpeg" alt="Logo Performance" fill sizes="48px" className="object-cover" />
          </div>
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            <span className="font-black text-lg tracking-tighter text-white">PERFORMANCE</span>
            <span className="text-[8px] text-red-500 font-bold uppercase tracking-[0.2em] mt-1">Centro de Treinamento</span>
          </div>
        </Link>
        ...
        {/* 3. Menu Horizontal */}
        <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '16px' }} className="mb-4">
          <Link href="/" className="text-gray-300 hover:text-red-500 font-bold uppercase tracking-wider text-[10px] transition-colors">Home</Link>
          <Link href="/views/Sobre" className="text-gray-300 hover:text-red-500 font-bold uppercase tracking-wider text-[10px] transition-colors">Sobre</Link>
          <Link href="/views/Planos" className="text-gray-300 hover:text-red-500 font-bold uppercase tracking-wider text-[10px] transition-colors">Planos</Link>
          <Link href="/views/Contato" className="text-gray-300 hover:text-red-500 font-bold uppercase tracking-wider text-[10px] transition-colors">Contato</Link>
        </div>

        {/* 4. Redes Sociais */}
        <div style={{ display: 'flex', justifyContent: 'center', gap: '16px' }} className="mb-4">
        ...
        <div 
          style={{ width: '100%', borderTop: '1px solid rgba(255,255,255,0.1)', paddingTop: '16px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}
        >
          <p style={{ margin: '0 0 8px 0', fontSize: '10px', color: '#6b7280', textAlign: 'center', width: '100%' }}>
            © {year} Performance Centro de Treinamento. Todos os direitos reservados.
          </p>
          <div style={{ display: 'flex', justifyContent: 'center', gap: '16px', fontSize: '9px', color: '#4b5563' }}>
